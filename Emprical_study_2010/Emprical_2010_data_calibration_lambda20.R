...
LAMBDA_SKEW <- as.numeric(Sys.getenv("PHASEM_LAMBDA_SKEW", "2.0"))
...
out_dir <- file.path(base_dir, "data", "EmpiricalStudy", "phaseM_2010_rheston_calibration_lambda20_output")
