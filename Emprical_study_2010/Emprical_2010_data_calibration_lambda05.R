...
# ============================================================
# Empirical Phase M2: 2010 SPX model comparison, lambda_skew = 0.5
# ------------------------------------------------------------
# File name:
#   PhaseM_2010_rheston_calibration_lambda05.R
#
# Purpose:
...
LAMBDA_SKEW <- as.numeric(Sys.getenv("PHASEM_LAMBDA_SKEW", "0.5"))
...
out_dir <- file.path(base_dir, "data", "EmpiricalStudy", "phaseM_2010_rheston_calibration_lambda05_output")
